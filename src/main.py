...
if __name__ == "__main__":
    ...
    factors_to_test = [
        ...
        # {"factor_name": "marginal_beta", "display_name": "边际贝塔因子", "window": 21},
        # {"factor_name": "upside_beta", "display_name": "边际上行贝塔", "window": 21},
        # {"factor_name": "downside_beta", "display_name": "边际下行贝塔", "window": 21},
        # 继续添加...
    ]
